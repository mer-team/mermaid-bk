...
route.get("/feedback/agrees/:song_classification_id", FeedbackController.getTotalAgrees)
route.get("/feedback/disagrees/:song_classification_id", FeedbackController.getTotalDisagrees)
